...
public:
	...
	constexpr FlattenWrapper(Iterator current, Iterator begin, Iterator end) noexcept:
...
public:
	...
	LZ_CONSTEXPR_CXX_14 FlattenIterator(Iterator it, Iterator begin, Iterator end) noexcept:
...
public:
	...
	constexpr FlattenIterator(Iterator it, Iterator begin, Iterator end) noexcept:
