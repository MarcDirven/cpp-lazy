...
class Except final : public internal::BasicIteratorView<internal::ExceptIterator<Iterator, IteratorToExcept, Comparer, Execution>> {
#else
...
public:
	...
	LZ_CONSTEXPR_CXX_20 Except(Iterator begin, Iterator end, IteratorToExcept toExceptBegin, IteratorToExcept toExceptEnd,
		...
		internal::BasicIteratorView<iterator>(
			iterator(std::move(begin), end, toExceptBegin, toExceptEnd, comparer, execPolicy),
