...
TEST_CASE("Zip changing and creating elements", "[Zip][Basic functionality]") {
    ...
    SECTION("Should stop at smallest container") {
        ...
        for (auto tup : lz::it::zip(a, b, smallest)) {
            (void) tup;
            counter++;
        }
...
TEST_CASE("Zip to containers", "[Zip][To container]") {
    ...
    SECTION("To array") {
        auto array = lz::it::zip(a, b, c).toArray<size>();
    ...
    SECTION("To vector") {
        auto vector = lz::it::zip(a, b, c).toVector();
    ...
    SECTION("To other container using to<>()") {
        auto list = lz::it::zip(a, b, c).to<std::list>();
